...
ul.dropdown li a:link, ul.dropdown li a:visited { display: block; padding: 0 5px; color: #606060; font-weight: bold; font-size: 15px; text-decoration: none; }
ul.dropdown li a:hover, ul.dropdown li a:active { display: block; padding: 0 5px; color: #000000; font-weight: bold; font-size: 15px; text-decoration: underline; }
...
ul.dropdown ul li a:link, ul.dropdown ul li a:visited { width: 100%; display: inline-block; margin: 0; padding: 0; color: #606060; font-weight: bold; font-size: 15px; text-decoration: none; } 
ul.dropdown ul li a:hover, ul.dropdown ul li a:active { width: 100%; display: inline-block; margin: 0; padding: 0; color: #000000; font-weight: bold; font-size: 15px; text-decoration: underline; } 
...
*/
--%>
#page_header a.attention { color: #DC143C; }
// -->
</style>